            ...
            child: Column(
              children: [
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    focusedErrorBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(width: 0.5, color: PRIMARY_COLOR),
                    ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    suffixIcon: userProvider.passwordToggle?IconButton(icon: Icon(Icons.visibility), onPressed:(){userProvider.passwordToggle=false;}):IconButton(icon: Icon(Icons.visibility_off), onPressed: (){userProvider.passwordToggle=true;}),
                    labelText: PASSWORD,
                    focusedErrorBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(16),
                      borderSide: BorderSide(width: 0.5, color: PRIMARY_COLOR),
                ...
                RaisedButton(
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      userProvider.login(_mobNoController.text, _passwordController.text);
                    }
